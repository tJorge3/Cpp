...
{
	 int i=0;
	 // char é usada como armazenamento podendoser numero, palavra ou caracter 
	 
	  //str é uma variavel do tipo refererncia, ela contem um indereço objeto 
 ...
 */
  while (str[i])
  {
   ...
   /* if  estabelece que execute um determinado código de acordo com uma linha
	...
	comandonde comparação, e retorna se é verdaderio 
    */
    else{
